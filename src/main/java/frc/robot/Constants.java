...
public final class Constants {
  ...
  public static final class CoralSubsystemConstants {
    ...
    public static final double kArmReversalThreshold = 90.0; // 90 degrees or any angle you want to set
    ...
    public static final class ArmSetpoints {
      ...
      public static final double kLevel1 = 1.5;
      public static final double kLevelA = 1;
    ...
    public static final class IntakeSetpoints {
      ...
      public static final double KSlow = 0.10;
  ...
  public static final class ModuleConstants {
    ...
    public static final double kWheelDiameterMeters = 0.0702;
  ...
  public static final class OIConstants {
    ...
    public static final double kDriveForwardBackward = 1.0;
    public static final double kDriveLeftRight = 1.0;
