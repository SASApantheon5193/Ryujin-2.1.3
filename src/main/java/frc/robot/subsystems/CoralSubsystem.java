...
public class CoralSubsystem extends SubsystemBase {
        ...
        () -> {
          switch (setpoint) {
            ...
            case kLevel1:
              ...
              break;
              case kLevelA:
              armCurrentTarget = ArmSetpoints.kLevelA;
              elevatorCurrentTarget = ElevatorSetpoints.kLevel1;
              break;
            case kLevel2:
  ...
  public Command reverseIntakeSlow() {
    return this.startEnd(
        () -> this.setIntakePower(IntakeSetpoints.KSlow), () -> this.setIntakePower(0.0));
  }
  ...
  public Command AutoIntakeCommand() {
    return new InstantCommand(() -> this.setIntakePower(IntakeSetpoints.kReverse));
  }
